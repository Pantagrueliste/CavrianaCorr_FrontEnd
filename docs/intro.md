...
If you use these materials in your research, please cite the edition:

> Clément Godbarge (ed.). *Filippo Cavriana: The Secret Correspondence*. Zenodo. https://doi.org/10.5281/zenodo.8224585

Each letter page also carries its own suggested citation. The DOI above is the concept DOI, which always resolves to the latest version of the edition.
